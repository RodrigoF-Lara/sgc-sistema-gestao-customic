...
/**
 * Handlers de cargos (embutidos em /api/shared/config?tipo=niveis
 * para não criar Serverless Function extra no Vercel Hobby).
 */
...
export async function handleNiveis(req, res, pool, method) {
  if (method === "GET") {
